...
class Movie():  #creates way to store information about a movie, particularly the title,
    ...
    def __init__(self, movie_title, movie_storyline, poster_image, trailer_youtube):
        ...
        #assigned to variables in that program(in this case entertainment_center.py
        self.title = movie_title
        self.storyline = movie_storyline
        self.poster_image_url = poster_image
        self.trailer_youtube_url = trailer_youtube

    #This function will open the trailer for the self(movie). We have to import    
